    ...
    >
      <defs id="l_d_774">
        <clipPath id="__lottie_element_294">
          <rect id="l_d_777" width="45" height="45" x="0" y="0"></rect>
        </clipPath>
      </defs>
      <g id="l_d_775" clipPath="url(#__lottie_element_294)">
        <g
          id="l_d_800"
          transform="matrix(1,0,0,1,-22.875,-16.75)"
          opacity="1"
          className="block"
        >
          <g id="l_d_804" opacity="1" transform="matrix(1,0,0,1,0,0)">
            <g id="l_d_805" opacity="1" transform="matrix(1,0,0,1,40,42)">
              <path
                id="l_d_806"
                strokeLinecap="butt"
            ...
            <g id="l_d_807" opacity="1" transform="matrix(1,0,0,1,40,31)">
              <path
                id="l_d_808"
                strokeLinecap="butt"
            ...
            <g id="l_d_809" opacity="1" transform="matrix(1,0,0,1,40,27)">
              <path
                id="l_d_810"
                strokeLinecap="butt"
                strokeLinejoin="round"
        ...
        <g
          ...
          className="block"
        >
          <g id="l_d_782" opacity="1" transform="matrix(1,0,0,1,0,0)">
            <g
              id="l_d_783"
              opacity="1"
              transform="matrix(1,0,0,1,40,47.63399887084961)"
            >
              <path
                id="l_d_784"
                strokeLinecap="butt"
          ...
          <g id="l_d_785" opacity="1" transform="matrix(1,0,0,1,40,51)">
            <path
              id="l_d_786"
              strokeLinecap="butt"
              strokeLinejoin="round"
